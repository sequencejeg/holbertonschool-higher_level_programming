#!/usr/bin/python3
"""
On this script we list all states with a name starting with N
from the database hbtn_0e_0_usa. It takes 3 command-line
args: MySQL username, password, and database name.
"""
